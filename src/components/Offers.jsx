  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 md:mx-14 mx-8 my-16 text-white font-OpenSans'>
        <div className='bg-r-btn px-6 py-7 rounded-2xl'>
            ...
            <p className='text-lg pt-2'>Bring your friends to Delivery and get upto 15% off</p>
            <p className='text-sm text-right pt-2'>*Conditions apply</p>
        </div>
        ...
        <div className='bg-r-dbtn px-6 py-7 rounded-2xl'>
            ...
            <p className='text-lg pt-2'>Buy one get one free on selected items! Free delivery</p>
            <p className='text-sm text-right pt-2'>*Conditions apply</p>
        </div>
    </div>
  ) 
